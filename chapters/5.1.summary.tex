...
Upon contact, members from \sugg{a large technology company} in Sweden granted the opportunity to spend some time at their offices to observe practices, collect data and interview team members.
This chapter synthesizes the \sugg{findings of a seven-week period which was spent in Sweden in direct contact with the company}.
\todo{Is it ok to mention the seven-week timeframe?}

The interacted team is responsible \sugg{for a software system, which is an integral component of the company's delivered product}.
Specifically, \sugg{practices related to multi-component testing (MCT) were investigated; at the time, there were thousands of MCTs in the system}.
...
\Cref{sec:ind_overview} provides an overview of the testing process at \sugg{the company} and of the system for which the interviewed team is responsible.
