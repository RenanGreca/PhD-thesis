...
During a seven-week period, an investigation was conducted in partnership with Ericsson in Sweden; the results of which can be found in \autoref{chap:industry}.
